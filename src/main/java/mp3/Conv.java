...
public class Conv {
    ...
    public static void printMp3Metadata(File mp3, Charset from, Charset to)
	...
	try {
	    ...
	    // System.err.println("Error occurred with this file - " +
	    // mp3.getName());
	}
    ...
    // public static List<Tuple2<Charset, Charset>> getEncodings() throws
    // Exception{
    public static void getEncodings() throws Exception {
	// File f = new File("encodingMapping");
	// Path p = Paths.get(f.getPath());
	// List<Tuple2<Charset, Charset>> en = new ArrayList<Tuple2<Charset,
	// Charset>>();
	// try{
	...
	// Tuple2<String, String> tuple = new Tuple2<String, String>(split[0],
	// split[1]);
	// encodings.add(tuple);
	// }
	// }
